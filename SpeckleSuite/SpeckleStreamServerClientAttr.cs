...
{
    internal class SpeckleStreamServerClientAttr : Grasshopper.Kernel.Attributes.GH_ComponentAttributes
    {
        private SpeckleStreamServerClient owner;
        private Rectangle SendStreamButtonBounds;
        private Rectangle PlayPauseButtonBounds;
        private Rectangle SetServerIdButtonBounds;

        public SpeckleStreamServerClientAttr(SpeckleStreamServerClient owner) : base(owner)
        {
            this.owner = owner;
        }
        ...
        protected override void Render(GH_Canvas canvas, Graphics graphics, GH_CanvasChannel channel)
        {
            ...
            if (channel == GH_CanvasChannel.Objects)
            {
                ...
                GH_Capsule button3 = GH_Capsule.CreateTextCapsule(SetServerIdButtonBounds, SetServerIdButtonBounds, GH_Palette.White, owner.serverId == null || owner.serverId == "" ? @"Set Server Id" : owner.serverId, 0, 0);
